...
#define ALLOCATION_ERROR_MESSAGE "Allocation error:Failed to allocate memory\n"
#define SUCCESS 0
#define FAILURE 1
#define MAXWORDLEN 100
#define MAXSENTENCELEN 1000
#define WORDSINTWEET 20

/***************************/
/*   insert typedefs here  */
/***************************/
typedef struct NextNodeCounter *NextNodeCounterType;
typedef void *gen_data;
typedef void (*gen_print) (gen_data);
typedef int (*gen_comp) (gen_data, gen_data);
typedef void (*gen_free) (gen_data);
typedef gen_data (*gen_cpy) (gen_data);
typedef bool (*gen_last) (gen_data);
/***************************/
...
typedef struct MarkovNode {
    gen_data data;
    NextNodeCounterType frequencies_list;
 ...
 * database.
 */
Node *get_node_from_database (const MarkovChain *markov_chain, void *data_ptr);
